...
def get_default_settings() -> Settings:
    ...
    return Settings(
        ...
        chat_model_provider=get_default_value("chat_model_provider", "ollama"),
        chat_model_name=get_default_value("chat_model_name", "llama3.2"),
        ...
        util_model_provider=get_default_value("util_model_provider", "ollama"),
        util_model_name=get_default_value("util_model_name", "llama3.2"),
        ...
        browser_model_provider=get_default_value("browser_model_provider", "ollama"),
        browser_model_name=get_default_value("browser_model_name", "llama3.2"),
